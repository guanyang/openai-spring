package org.gy.framework.openai.utils;
...
import org.gy.framework.openai.pojos.OpenAi;
...
public class OpenAiUtils {
    ...
    public static final OpenAi DEFAULT_AI = new OpenAi("OpenAi01", "问&答", "依据现有知识库问&答", "text-davinci-003", "Q: %s\nA:", 0.0, 1.0, 1.0, 0.0, 0.0, "\n");
    ...
    public static List<CompletionChoice> getAiResult(String openAiType, String... texts) {
        OpenAi openAi = PARMS.getOrDefault(openAiType, DEFAULT_AI);
        return getAiResult(openAi, String.format(openAi.getPrompt(), texts));
    }
